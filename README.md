...
Dom Says
The purpose of this assignment is to demonstrate mastery in some basic Tableau skills. With that in mind, there's no reason at all to use a gigantic dataset, especially when a smaller dataset will load and save more quickly, and will be just as effective in allowing you to show what you can do.
Tableau Public limits the size of your dataset to 10,000,000 rows. But I recommend you stick with something much smaller than that; e.g., maybe 100,000 rows? Maybe 500,000 rows?
This means you'll have to use the skills you've developed in the previous 17 weeks to merge, filter, and limit your dataset.
